...
def totalcost():
    ...
    item20=int(e_Chicken_Manchuria.get())
...
biryanisFrame=LabelFrame(menuFrame,text="Biryani",font=("arial",19,"bold"),bd=10,relief=RIDGE)
biryanisFrame.pack(side=LEFT)
...
e_Chicken_Manchuria=StringVar()
e_Chicken_Drumsticks=StringVar()
e_Chicken_kabab=StringVar()
e_Egg_Manchuria=StringVar()
e_Veg_Manchuria=StringVar()
e_Fried_Mushroom=StringVar()
e_BabyCorn=StringVar()
e_Panner_Tikka=StringVar()

costofMaincoursevar=StringVar()
costofBiryanivar=StringVar()
costofStartersvar=StringVar()
costofSubtotalvar=StringVar()
costofServicetaxvar=StringVar()
costofTotalcostvar=StringVar()
...
##maincourse
Butter_Chicken =Checkbutton(maincourseFrame,text="Butter Chicken-349",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var1,command=Butter_Chicken)
Butter_Chicken.grid(row=0,column=0,sticky=W)
Chicken_Kolapuri =Checkbutton(maincourseFrame,text="Chicken kolapuri-369",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var2,command=Chicken_Kolapuri)
Chicken_Kolapuri.grid(row=1,column=0,sticky=W)
Telangana_Chicken =Checkbutton(maincourseFrame,text="Telangana Chicken-369",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var3,command=Telangana_Chicken)
Telangana_Chicken.grid(row=2,column=0,sticky=W)
Mutton_Kheema=Checkbutton(maincourseFrame,text="Mutton Kheema-449",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var4,command=Mutton_Kheema)
Mutton_Kheema.grid(row=3,column=0,sticky=W)
Mutton_Curry=Checkbutton(maincourseFrame,text="Mutton Curry-424",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var5,command=Mutton_Curry)
Mutton_Curry.grid(row=4,column=0,sticky=W)
Fish_Pulusu=Checkbutton(maincourseFrame,text="Fish Pulusu-489",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var6,command=Fish_Pulusu)
Fish_Pulusu.grid(row=5,column=0,sticky=W)
Veg_Kofta=Checkbutton(maincourseFrame,text="Veg Kofta-299",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var7,command=Veg_Kofta)
Veg_Kofta.grid(row=6,column=0,sticky=W)
Butter_Panner=Checkbutton(maincourseFrame,text="Butter Panner-199",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var8,command=Butter_Panner)
Butter_Panner.grid(row=7,column=0,sticky=W)
Mushroom=Checkbutton(maincourseFrame,text="Mushroom-169",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var9,command=Mushroom)
Mushroom.grid(row=8,column=0,sticky=W)

#entry fields for maincourse
textButter_Chicken=Entry(maincourseFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Butter_Chicken)
textButter_Chicken.grid(row=0,column=1)
textChicken_Kolapuri=Entry(maincourseFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Chicken_Kolapuri)
textChicken_Kolapuri.grid(row=1,column=1)
textTelangana_Chicken=Entry(maincourseFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Telangana_Chicken)
textTelangana_Chicken.grid(row=2,column=1)
textMutton_Kheema=Entry(maincourseFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Mutton_Kheema)
textMutton_Kheema.grid(row=3,column=1)
textMutton_Curry=Entry(maincourseFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Mutton_Curry)
textMutton_Curry.grid(row=4,column=1)
textFish_Pulusu=Entry(maincourseFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Fish_Pulusu)
textFish_Pulusu.grid(row=5,column=1)
textVeg_Kofta=Entry(maincourseFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Veg_Kofta)
textVeg_Kofta.grid(row=6,column=1)
textButter_Panner=Entry(maincourseFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Butter_Panner)
textButter_Panner.grid(row=7,column=1)
textMushroom=Entry(maincourseFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Mushroom)
textMushroom.grid(row=8,column=1)

#Biryaniframe
Chicken_Dum_Biryani=Checkbutton(biryanisFrame,text="Chicken Dum Biryani-350",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var10,command=Chicken_Dum_Biryani)
Chicken_Dum_Biryani.grid(row=0,column=0,sticky=W)
Chicken_Frypiece_Biryani=Checkbutton(biryanisFrame,text="Chicken Frypiece Biryani-399",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var11,command=Chicken_Frypiece_Biryani)
Chicken_Frypiece_Biryani.grid(row=1,column=0,sticky=W)
Chicken_Biryani_Spl=Checkbutton(biryanisFrame,text="Chicken Biryani Spl-399",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var12,command=Chicken_Biryani_Spl)
Chicken_Biryani_Spl.grid(row=2,column=0,sticky=W)
Mutton_Nallighosh_Biryani=Checkbutton(biryanisFrame,text="Mutton Nallighosh Biryani-449",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var13,command=Mutton_Nallighosh_Biryani)
Mutton_Nallighosh_Biryani.grid(row=3,column=0,sticky=W)
Mutton_Juicy_Biryani=Checkbutton(biryanisFrame,text="Mutton Juicy Biryani-469",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var14,command=Mutton_Juicy_Biryani)
Mutton_Juicy_Biryani.grid(row=4,column=0,sticky=W)
Fish_Biryani=Checkbutton(biryanisFrame,text="Fish Biryani-510",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var15,command=Fish_Biryani)
Fish_Biryani.grid(row=5,column=0,sticky=W)
Prawn_Biryani=Checkbutton(biryanisFrame,text="Prawn Biryani-470",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var16,command=Prawn_Biryani)
Prawn_Biryani.grid(row=6,column=0,sticky=W)
Veg_Pulao=Checkbutton(biryanisFrame,text="Veg Pulao-220",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var17,command=Veg_Pulao)
Veg_Pulao.grid(row=7,column=0,sticky=W)
Panner_Biryani=Checkbutton(biryanisFrame,text="Panner Biryani-250",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var18,command=Panner_Biryani)
Panner_Biryani.grid(row=8,column=0,sticky=W)

#entry fields for biryani
textChicken_Dum_Biryani=Entry(biryanisFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Chicken_Dum_Biryani)
textChicken_Dum_Biryani.grid(row=0,column=1)
textChicken_Frypiece_Biryani=Entry(biryanisFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Chicken_Frypiece_Biryani)
textChicken_Frypiece_Biryani.grid(row=1,column=1)
textChicken_Biryani_Spl=Entry(biryanisFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Chicken_Biryani_spl)
textChicken_Biryani_Spl.grid(row=2,column=1)
textMutton_Nallighosh_Biryani=Entry(biryanisFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Mutton_Nallighosh_Biryani)
textMutton_Nallighosh_Biryani.grid(row=3,column=1)
textMutton_Juicy_Biryani=Entry(biryanisFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Mutton_Juicy_Biryani)
textMutton_Juicy_Biryani.grid(row=4,column=1)
textFish_Biryani=Entry(biryanisFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Fish_Biryani)
textFish_Biryani.grid(row=5,column=1)
textPrawn_Biryani=Entry(biryanisFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Prawn_Biryani)
...
textPanner_Biryani=Entry(biryanisFrame,font=("arial",12,"bold"),bd=7,width=6,state=DISABLED,textvariable=e_Panner_Biryani)
textPanner_Biryani.grid(row=8,column=1)



#Startersframe
Chicken_Mangolia=Checkbutton(startersFrame,text="Chicken Mangolia-210",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var19,command=Chicken_Mangolia)
Chicken_Mangolia.grid(row=0,column=0,sticky=W)
Chicken_Manchuria=Checkbutton(startersFrame,text="Chicken Manchuria-189",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var20,command=Chicken_Manchuria)
Chicken_Manchuria.grid(row=1,column=0,sticky=W)
Chicken_Drumsticks=Checkbutton(startersFrame,text="Chicken Drumsticks-210",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var21,command=Chicken_Drumsticks)
Chicken_Drumsticks.grid(row=2,column=0,sticky=W)
Chicken_Kabab=Checkbutton(startersFrame,text="Chicken Kabab-240",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var22,command=Chicken_Kabab)
Chicken_Kabab.grid(row=3,column=0,sticky=W)
Egg_Manchuria=Checkbutton(startersFrame,text="Egg Manchuria-199",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var23,command=Egg_Manchuria)
Egg_Manchuria.grid(row=4,column=0,sticky=W)
Veg_Manchuria=Checkbutton(startersFrame,text="Veg Manchuria-170",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var24,command=Veg_Manchuria)
Veg_Manchuria.grid(row=5,column=0,sticky=W)
Fried_Mushroom=Checkbutton(startersFrame,text="Fried Mushroom-170",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var25,command=Fried_Mushroom)
Fried_Mushroom.grid(row=6,column=0,sticky=W)
Baby_Corn=Checkbutton(startersFrame,text="Baby Corn-190",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var26,command=Baby_Corn)
Baby_Corn.grid(row=7,column=0,sticky=W)
Panner_Tikka=Checkbutton(startersFrame,text="Panner Tikka-199",font=("arial",8,"bold"),onvalue=1,offvalue=0,variable=var27,command=Panner_Tikka)
